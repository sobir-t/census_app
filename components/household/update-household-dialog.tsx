...
export default function UpdateHouseholdDialog({
  authUser,
  household,
  setEditHouseholdOpen,
  ...
  const [newLienholderId, setNewLienholderId] = useState<number | null>(
    lienholderId,
  );
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px]">
        ...
        <DialogDescription>
          Your household information will be attached to every member in your
          household.
        </DialogDescription>
        <Form {...form}>
          <form
            ...
            <div className="grid grid-cols-12 gap-2">
              <FormField
                ...
                render={({ field }) => (
                  <FormItem
                    id="homeType"
                    className="col-span-6 SingleSelectDropdown"
                  >
                    ...
                    >
                      <FormControl>
                        <SelectTrigger>
                          <SelectValue
                            defaultValue={household?.homeType || "jhbjhb"}
                          />
                        </SelectTrigger>
                      </FormControl>
                      <SelectContent>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem
                    id="state"
                    className="col-span-3 SingleSelectDropdown"
                  >
